...
public enum EventMessages {
    ...
    MESSAGE_OS_FULL_NAME (2, "Operating system changed"),
    MESSAGE_BIOS_DESCRIPTION (3, "BIOS changes"),
    MESSAGE_BIOS_MANUFACTURER (4, "BIOS manufacturer changed"),
    MESSAGE_BIOS_NAME (5, "BIOS name changed"),
    MESSAGE_BIOS_RELEASE_DATE (6, "BIOS release date changed"),
    MESSAGE_BIOS_VERSION (7, "BIOS version changed"),
    MESSAGE_CPU_ID (8, "CPU id changed"),
    MESSAGE_CPU_IDENTIFIER (9, "CPU identifier changed"),
    MESSAGE_CPU_NAME (10, "CPU name changed"),
    MESSAGE_CPU_VENDOR (11, "CPU vendor changed"),
